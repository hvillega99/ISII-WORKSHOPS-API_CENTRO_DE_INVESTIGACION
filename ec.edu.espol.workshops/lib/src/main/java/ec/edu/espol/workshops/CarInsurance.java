...
public class CarInsurance {
    ...
    private final int basepremium = 500;
    private final int malesingle = 1500;
    private final int femalemarried = 200;
    private final int olderyounger = 100;
    ...
    */
    public int totalCalc() {
        ...
        if (this.sexcustomer == "M" && this.maritalstatus == "not married" && this.agecustomer > 25) {
            total = total + malesingle;
        } else if (this.sexcustomer == "F" || this.maritalstatus == "married") {
